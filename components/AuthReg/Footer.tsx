...
import "../../styles/FooterAuthReg.module.scss";
    ...
    <div className="Footer">
      {type === "reg" ? (
        <div className="Footer-policeLOGIN">
          <div
            className="policeRemember"
            style={{ marginTop: type === "reg" ? 45 : 23 }}
          >
            <span className="black txt">
              with registering your accepting our{" "}
            </span>
            <span className="orange txt click"> terms </span>
            <span className="black txt">and </span>
            <span className="orange txt click">
              privacy <br /> policy
            </span>
          </div>
          <div
            className="button"
            style={{ marginTop: type === "reg" ? 12 : 66 }}
          >
            {type === "reg" ? "Register" : "Login"}
          </div>
          <div style={{ marginTop: 75, marginBottom: 43 }}>
            <span className="black txt">Already have an account? </span>
            <Link href="/login">
              <span
                className="orange txt click"
                onClick={() => setType("log")}
              >
                Login
              </span>
        ...
        <div className="qa">
          ...
          <div style={{ marginTop: 73, marginBottom: 67 }}>
            <span className="black txt">dont have an account?</span>
